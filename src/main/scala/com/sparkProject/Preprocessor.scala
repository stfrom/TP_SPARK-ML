...
object Preprocessor {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val df: DataFrame = spark
      ...
      .csv("/Users/charlesrohmer/MasterBigData/INF729-Spark_Hadoop/SPARK_TP/TP_ParisTech_2017_2018_starter/data/train.csv")
    ...
    dfFiltered.write.mode(SaveMode.Overwrite).parquet("/Users/charlesrohmer/MasterBigData/INF729-Spark_Hadoop/SPARK_TP/TP_ParisTech_2017_2018_starter/data/prepared_trainingset")
